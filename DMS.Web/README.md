...
The mobile web app is a separate ASP.NET Core Razor Pages client for developer daily updates. It uses the existing DMS API and does not connect directly to MongoDB.
...
The web app uses secure, HTTP-only cookies and accepts developer accounts only. Submission authorization and one-update-per-day enforcement remain in the API.
